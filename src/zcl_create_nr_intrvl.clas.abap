CLASS zcl_create_nr_intrvl DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zcl_create_nr_intrvl IMPLEMENTATION.
  ...
  " Define interval configuration parameters
    ...
    lt_intervals = VALUE #( (
      ...
      fromnumber = '0000000001'   " Numeric range bottom edge
      tonumber   = '9999999999'   " Numeric range top edge
    ...
    " Catch the specific missing object exception
      CATCH cx_nr_object_not_found INTO DATA(lx_not_found).
        out->write( |Error: The Number Range Object ZPPM_NR does not exist. { lx_not_found->get_text( ) }| ).
